...
class Bone:
    ...
    def __init__(self, bone_data=None, arr_shape=None, spine_width=100, rib_diameter=30,
        ...
        self.mean_z_distance_on_xoy = None
    ...
    def selective_initial(self):
        if self.detection_objective == 'rib':
            ...
            self.set_mean_z_distance_on_xoy()
    ...
    """
    def set_mean_z_distance_on_xoy(self):
        z_distance = self.bone_data.groupby('x').agg({'z': ['max', 'min']})
    ...
    def get_mean_z_distance_on_xoy(self):
        return self.mean_z_distance_on_xoy
    ...
    def is_mid_rib(self):
        ...
        if self.get_mean_z_distance_on_xoy() > self.rib_diameter:
            return False
    ...
    def is_complete_sternum(self):
        ...
        """
        if self.get_mean_z_distance_on_xoy() < 50:
            return False
        """
    ...
    def print_bone_info(self):
        ...
        print('z_distance_max is', self.set_mean_z_distance_on_xoy())
