...
class Bone:
    ...
    def is_complete_sternum(self):
        ...
        # if self.get_iou_on_xoy() < 0.4:
        #     return False

        if abs(y_centroid - self.y_mid_line) < 100:
            return False
    ...
    def judge_not_spine_or_sternum_speedup(self):
        ...
        temp_df = self.prior_zoy_center_y_axis_line_df[(self.prior_zoy_center_y_axis_line_df['z'] > z_centroid - 5) & (self.prior_zoy_center_y_axis_line_df['z'] < z_centroid + 5)]
