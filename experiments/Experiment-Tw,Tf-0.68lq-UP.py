...
def plotcontext(L=88, R=6.28, step=0.1, savepath=None):
    ...
    grid = plt.GridSpec(13, 5, wspace=1.0, hspace=0.0)

    # 下图
    main_ax = plt.subplot(grid[3:13, 0:5])
    ...
    ax1 = plt.subplot(grid[0:3, 0:5], sharex=main_ax)
...
#################################################################################
    ...
    a = range(80)
    b = 20
    pup1 = plt.plot(a, range(b, b+80,1), marker='s', markerfacecolor='black', color='black', markeredgecolor='black',
                    linestyle='solid', label='DW')
    b = 22
    pup1f = plt.plot(a, range(b, b+80,1), color='black', linestyle=':', linewidth=1.5, label='')
    b = 24
    pup2 = plt.plot(a, range(b, b+80,1), marker='o', markerfacecolor='red', color='black', markeredgecolor='red',
                    linestyle='solid', label='DW')
    b = 26
    pup2f = plt.plot(a, range(b, b+80,1), color='red', linestyle=':', linewidth=1.5, label='')
    b = 28
    pup3 = plt.plot(a, range(b, b+80,1), marker='v', markerfacecolor='blue', color='black', markeredgecolor='blue',
                    linestyle='solid', label='DW')
    b = 30
    pup3f = plt.plot(a, range(b, b+80,1), color='blue', linestyle=':', linewidth=1.5, label='')
    b = 32
    pup4 = plt.plot(a, range(b, b+80,1), marker='^', markerfacecolor='green', color='black', markeredgecolor='green',
                    linestyle='solid', label='DW')
    b = 34
    pup4f = plt.plot(a, range(b, b+80,1), color='green', linestyle=':', linewidth=1.5, label='')

    b = 36
    ptpc = plt.plot(a, range(b, b+80,1), color='black', linestyle="-.", linewidth=1.5, label='T$_{pc}$')
